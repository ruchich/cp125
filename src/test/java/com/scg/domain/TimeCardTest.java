   ...
   /** @Test
    public void toReportString(){
       ...
       String actual = tC.toReportString().trim();
        String expected = String.format("====================================================================%nConsultant: Robin , Singh NMN\t\t Week Starting: Jan 20, 2017\nBillable Time:\nAccount\t\t\tDate\t\tHours\tSkill%n----------------------  --------------  -----   --------------------%nXYZ Consultant\t01/20/2017\t8\tSOFTWARE_ENGINEER\nABC Consultant\t01/20/2017\t8\tSOFTWARE_ENGINEER\n\nNon-Billable Time:\nAccount\t\t\tDate\t\tHours\tSkill%n----------------------  --------------  -----   --------------------%nSummary:\nTotal Billable Hours:\t\t\t 16 %nTotal Non-Billable Hours: \t\t 0 %nTotal Hours:  \t\t\t\t16 %n%n====================================================================");
